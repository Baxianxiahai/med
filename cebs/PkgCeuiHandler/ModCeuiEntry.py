...
#UI Class
import PkgCeuiHandler.ModCeuiMain
...
def cetk_show_app(app, splash, TkMainUi, TkCalibUi, TkGparUi, TkMengUi, tkStestUi, TkBrowUi):
    ...
    mainWindow = PkgCeuiHandler.ModCeuiMain.SEUI_L4_MainWindow(TkMainUi, TkCalibUi, TkGparUi, TkMengUi, tkStestUi, TkBrowUi)
    mainWindow.show()
...
def cetk_l4ui_main_form_entry(TkMainUi, TkCalibUi, TkGparUi, TkMenUi):
    ...
    splash = cetk_show_startup_pic()
    QtWidgets.qApp.processEvents()
    mainWindow = PkgCeuiHandler.ModCeuiMain.SEUI_L4_MainWindow(TkMainUi, TkCalibUi, TkGparUi, TkMenUi)
    mainWindow.show()
    cetk_hide_startup_pic(splash)
    sys.exit(app.exec_())
    return
