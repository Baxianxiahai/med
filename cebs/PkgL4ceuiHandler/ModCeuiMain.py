...
class SEUI_L4_MainWindow(QtWidgets.QMainWindow, Ui_cebsMainWindow, clsL1_ConfigOpr):
    ...
    def initParameter(self):
        ...
        self.instL4CalibForm = PkgL4ceuiHandler.ModCeuiCalib.SEUI_L4_CalibForm(self.TkCalibUi)
        self.instL4GparForm = PkgL4ceuiHandler.ModCeuiGpar.SEUI_L4_GparForm(self.TkGparUi)
