...
/*
    get the version of this dll/so/dylib, which is: 30.13127.2018.1016
*/
#ifdef _WIN32
...
#define NNCAM_FRAMEINFO_FLAG_TIMESTAMP    0x02
...
#define NNCAM_MAX_AE_EXPTIME  350000  /* default: 350 ms */
#define NNCAM_MAX_AE_AGAIN    500
...
#define NNCAM_OPTION_AGAIN                0x10    /* enable or disable adjusting the analog gain when auto exposure is enabled. default value: enable */
...
#define NNCAM_IOCONTROLTYPE_GET_ALLSTATUS               0x02 /* a single bit field indicating the current logical state of all available line signals at time of polling */
#define NNCAM_IOCONTROLTYPE_GET_MODE                    0x03 /* 0x01->Input, 0x02->Output */
#define NNCAM_IOCONTROLTYPE_SET_MODE                    0x04
...
#define NNCAM_IOCONTROLTYPE_GET_INVERTER                0x07 /* boolean */
#define NNCAM_IOCONTROLTYPE_SET_INVERTER                0x08
#define NNCAM_IOCONTROLTYPE_GET_LOGIC                   0x09 /* 0x01->Positive, 0x02->Negative */
#define NNCAM_IOCONTROLTYPE_SET_LOGIC                   0x0a
#define NNCAM_IOCONTROLTYPE_GET_MINIMUMOUTPUTPULSEWIDTH 0x0b /* minimum signal width of an output signal (in microseconds) */
#define NNCAM_IOCONTROLTYPE_SET_MINIMUMOUTPUTPULSEWIDTH 0x0c
#define NNCAM_IOCONTROLTYPE_GET_OVERLOADSTATUS          0x0d /* boolean */
#define NNCAM_IOCONTROLTYPE_SET_OVERLOADSTATUS          0x0e
#define NNCAM_IOCONTROLTYPE_GET_PITCH                   0x0f /* Number of bytes separating the starting pixels of two consecutive lines */
#define NNCAM_IOCONTROLTYPE_SET_PITCH                   0x10
#define NNCAM_IOCONTROLTYPE_GET_PITCHENABLE             0x11 /* boolean */
#define NNCAM_IOCONTROLTYPE_SET_PITCHENABLE             0x12
#define NNCAM_IOCONTROLTYPE_GET_SOURCE                  0x13 /*
                                                                   0->ExposureActive
                                                                   1->TimerActive
                                                                   2->UserOutput
                                                                   3->TriggerReady
                                                               ...
                                                               */
#define NNCAM_IOCONTROLTYPE_SET_SOURCE                  0x14
#define NNCAM_IOCONTROLTYPE_GET_STATUS                  0x15 /* boolean */
#define NNCAM_IOCONTROLTYPE_SET_STATUS                  0x16
#define NNCAM_IOCONTROLTYPE_GET_DEBOUNCERTIME           0x17 /* debouncer time in microseconds */
#define NNCAM_IOCONTROLTYPE_SET_DEBOUNCERTIME           0x18
