# -*- coding: utf-8 -*-
# @Author: qwang011
# @Date:   2019-04-18 12:46:25
# @Last Modified 2019-05-09
# @Last Modified time: 2019-05-09 11:22:35
...
from PkgL3cebsHandler import ModCebsMain
...
def prj_cebs_main_entry():
    ...
    #
    '''
    # Init message and prepare send to all task, to make them transferred into
    # ACTIVE state
    initMsg = {}
    ...
    CebsInst = ModCebsMain.tupTaskMain(TUP_GL_CFG)
    initMsg['dst'] = TUP_TASK_ID_BASIC
    CebsInst.msg_send_in(initMsg)
    CebsInst.tup_dbg_print("Cebs Basic parameter set  success!")
