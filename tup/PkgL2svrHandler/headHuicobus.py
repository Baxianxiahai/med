        ...
        'groups': [
            {
                ...
                'groupkey': 'hb_selct', 
                'list': [
                    {'paraname': '托盘类型', 'parakey': 'hb_type', 'type': 'choice', 'max': '', 'min': '', 'value': 0, 'items': ['96_STANDARD', '48_STANDARD', '24_STANDARD', '12_STANDARD', '6_STANDARD', '384_STANDARD'], 'note': 'choice info'}]
            }, 
            {
                'groupname': '全局参数设置',
                'groupkey': 'glpar_set', 
             ...
             }, 
            {
                ...
                'list': [
                    ...
                    {'paraname': '二次曝光设置', 'parakey': 'autoexpo', 'type': 'checkbox', 'max': '', 'min': '', 'value': True, 'note': 'Note info'},
